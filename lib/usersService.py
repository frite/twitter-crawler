...
def is_user_greek(userObject):
    #  User is greek based on its profile info '''
    userAttrsList = [unicode(userObject.description.lower()), unicode(userObject.name.lower()),
                     unicode(userObject.lang.lower()), unicode(userObject.location.lower())]
...
def is_any_tweet_greek(tweetsObjectList):
